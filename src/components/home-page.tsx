...
import { IconX, IconCheck, IconArrowRight, IconChevronRight, IconBrandFacebook, IconBrandInstagram, IconBrandX, IconBrandLinkedin, IconBrandYoutube } from "@tabler/icons-react"
  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-5 text-[15px] font-medium text-brand-dark absolute left-1/2 -translate-x-1/2">
...
<a href="#benefits" className="hover:opacity-70 transition-opacity">
          ...
          <a href="#savings" className="hover:opacity-70 transition-opacity">
            Savings Calculator
          </a>
          <a href="#buyers" className="hover:opacity-70 transition-opacity">
            For Buyers
          </a>
        </div>
        ...
        <a
          href="#waitlist"
          className="inline-flex items-center px-5 py-2.5 rounded-full text-[15px] font-semibold text-white bg-primary hover:bg-primary/90 transition-colors"
        >
          Join Waitlist
        </a>
      </nav>
...
function HeroSection() {
  return (
    <section className="relative pt-32 pb-8 text-center px-4">
      {/* Social proof badge */}
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#f0f1f3] bg-white mb-8">
        <div className="flex -space-x-1.5">
          <img src={avatar1} alt="" className="size-5 rounded-full ring-2 ring-white object-cover" />
          <img src={avatar2} alt="" className="size-5 rounded-full ring-2 ring-white object-cover" />
          <img src={avatar3} alt="" className="size-5 rounded-full ring-2 ring-white object-cover" />
        </div>
        <span className="text-sm font-medium text-[#47474f]">
          Join early members all across Australia
        </span>
      </div>

      {/* Headline */}
      <h1 className="font-serif text-5xl md:text-[64px] leading-[1.2] text-[#020a0f] mb-6">
      ...
      {/* Subtitle */}
      <p className="text-lg text-[#1e2124] max-w-[640px] mx-auto mb-10 leading-relaxed">
      ...
      <a
        href="#waitlist"
        className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-semibold text-white bg-primary hover:bg-primary/90 shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] transition-colors"
      >
        Get early access
...
function HowItWorksIllustration1() {
  return (
    <div className="w-full aspect-square rounded-3xl bg-[#f6f6f8] relative overflow-hidden">
      <div className="absolute top-[77px] left-[41px] w-[calc(100%-82px)] space-y-6">
...
function BentoGrid() {
  return (
    <section id="features" className="pb-24 px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white ring-1 ring-black/5">
            <div className="h-[280px] bg-[#f0f0f2] rounded-t-2xl" />
            <div className="p-8">
              <p className="font-['Roboto_Mono_Variable'] text-[13px] font-semibold uppercase leading-[15.6px] text-primary mb-2">
                Guided selling
              </p>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white ring-1 ring-black/5">
            ...
            <div className="p-8">
              ...
              <p className="text-sm text-[#1e2124] leading-relaxed">
                Traditional agents take ~2.5% of your sale price. Reasy charges a flat fee of just $3,023 — no matter how much your home sells for.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Card 3 */}
          <div className="relative overflow-hidden rounded-2xl bg-white ring-1 ring-black/5">
            <div className="h-[200px] bg-[#f0f0f2] rounded-t-2xl" />
            <div className="p-8">
              <p className="font-['Roboto_Mono_Variable'] text-[13px] font-semibold uppercase leading-[15.6px] text-primary mb-2">
                Direct connection
              </p>
...
function SavingsCalculator() {
  ...
  const GATE_1 = 25      // Go Live
  const GATE_2 = 999     // Accept EOI
  const GATE_3 = 1999    // Settlement
  const REASY_TOTAL = GATE_1 + GATE_2 + GATE_3 // $3,023
  ...
  return (
    <section id="savings" className="pt-0 pb-24 px-4 -mt-1">
      <div className="max-w-[1148px] mx-auto bg-brand-dark rounded-3xl overflow-hidden py-20 px-8 text-center">
        {/* Headline */}
        ...
        <div className="max-w-[476px] mx-auto mb-12">
          ...
          <p className="text-[26px] font-medium text-white mb-6">
...
function ForBuyers() {
  const features = [
    {
      icon: IconCheck,
      title: "Browse private listings.",
      description:
        "Discover properties listed directly by sellers before they hit the mainstream portals. Get early access to homes you won't find anywhere else.",
    },
    {
      icon: IconCheck,
  ...
  return (
    <section id="buyers" className="py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        {/* Left — Content */}
        <div className="py-8 pl-4 lg:pl-14 max-w-[600px] ml-auto">
            <p className="font-['Roboto_Mono_Variable'] text-[13px] font-semibold uppercase leading-[15.6px] text-primary mb-3">
              For Buyers
            </p>
            <h2 className="font-serif text-4xl md:text-[44px] leading-[1.15] text-[#020a0f] mb-6">
              A better way to find your next home
            </h2>
            <p className="text-[17px] text-[#1e2124] leading-relaxed mb-10">
              Reasy gives buyers direct access to motivated sellers, transparent
              pricing, and guided support through every stage of the purchase —
              no agent required.
            </p>
            ...
            <div className="space-y-8">
              {features.map((feature, i) => (
                <div key={i} className="flex gap-4">
                  ...
                  <div>
                    <p className="text-[15px] text-[#020a0f] leading-relaxed">
        ...
        {/* Right — Screenshot placeholder, flush to right edge */}
        <div className="relative rounded-l-2xl overflow-hidden bg-[#f0f0f2] ring-1 ring-black/5 h-[580px] mr-0" />
        </div>
    </section>
  )
}
  ...
  const faqs = [
    {
      ...
      answer:
        "Reasy uses a simple gated pricing model. You pay $25 to publish your listing, $999 when you accept your first expression of interest, and $1,999 at settlement. That's a total of $3,023 — compared to tens of thousands in traditional agent commissions.",
    },
    {
  ...
  return (
    <section className="py-24 px-4">
      <div className="max-w-[700px] mx-auto">
        <h2 className="font-serif text-4xl md:text-5xl text-center text-[#020a0f] mb-12">
        ...
        <div className="divide-y divide-[#e6e6eb]">
          {faqs.map((faq, i) => (
            <div key={i}>
              ...
              >
                <span className="text-[15px] font-medium text-[#020a0f] pr-4">
                  {faq.question}
                </span>
                <IconChevronRight
                  className={cn(
                    "size-4 text-[#7a7a7a] flex-shrink-0 transition-transform duration-200",
  ...
  return (
    <section id="waitlist" className="py-24 px-4">
      <div className="max-w-[560px] mx-auto text-center">
        ...
        <p className="text-[17px] text-[#1e2124] leading-relaxed mb-10">
          Be one of the first to use Reasy when we launch. Register your interest below and we'll keep you updated.
        </p>
